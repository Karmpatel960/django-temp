...
# S3 Configuration
DEFAULT_FILE_STORAGE = 'myapp.storage.S3MediaStorage'
...
AWS_LOCATION = 'media'
AWS_QUERYSTRING_AUTH = False  # This disables signatures with querystrings

# Use local media files if AWS credentials are not provided
